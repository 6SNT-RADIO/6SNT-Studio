...
```
 01 STRATEGIST → 02 RESEARCHER → 03 UX/UI → 04 ARCHITECT → 05 DATA MODELER
                                                                  │
                                          06 FRONTEND ∥ 07 BACKEND│(parallel)
                                                                  ▼
                                    08 QA → 09 SECURITY → 10 TECH WRITER

 Human GATES:  G01      G02       G03        G04            G08      G10
             (BRIEF) (RESEARCH) (IDENTITY) (ARCH.)         (QA)   (RELEASE)
```
