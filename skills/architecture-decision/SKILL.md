...
description: Para el Architect (04). Evaluar el stack desde el problema (no por familiaridad) con 2-3 opciones por capa, criterios de viabilidad y la estructura del ARCHITECTURE.md. Úsalo en el gate de arquitectura.
---
