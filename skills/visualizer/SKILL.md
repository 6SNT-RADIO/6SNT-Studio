---
name: visualizer
description: Generar previews HTML vivos y autocontenidos de UI y diagramas que consumen el TOKENS.css del proyecto (cero hex hardcodeado, sin CDN, todos los estados, placeholders rotulados). Para 03 (UX/UI), 05 (Data Modeler), 06 (Frontend) y 08 (QA).
---
